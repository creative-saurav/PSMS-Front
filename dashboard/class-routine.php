			...
			<div class="row">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
                            ...
                            <?php if($classCount ==1 ) :?>
                            <?php 
                             $stm =$pdo->prepare("SELECT class.class_name,subjects.name as subject_name,subjects.code as subjects_code ,teacher.name as teacher_name,class_routine.time_from,class_routine.time_to,class_routine.day,class_routine.room_no FROM class_routine
